...
#### Scenario: Shipped documentation coherence

- **WHEN** a candidate archive is built for a version
- **THEN** its documentation names that version's archive names while historical version prose remains untouched
